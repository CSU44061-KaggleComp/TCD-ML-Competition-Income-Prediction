...
def main():
    ...
    #to avoid mismatch in train and test data after encoding
    ...
    #I was getting many negative values as predictions so I mapped them to 0, 
...
def submission(dataset,model,feature_scaler):
    ...
    #put predictions in sumbission file
